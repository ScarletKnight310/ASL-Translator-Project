# DISCLAMIMER STILL FIXING UP
# Inti data for processing data
...
# [Manual Capture] / Iterates thru whole library / For auto collection / prepare before running, sign -> wait -> sign / follow the terminal for current sign / press 'Q' to end
...
# Run this to create ur own data